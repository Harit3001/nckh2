            ...
            <div className="login-box">
                ...
                {activeTab === "email" && (
                    <form onSubmit={onSubmit} noValidate>
                        ...
                        {globalError && (
                            <p className="error global-error">{globalError}</p>
                        )}
                ...
                {activeTab === "wallet" && (
                    <div className="wallet-box-container">
                        ...
                        {globalError && (
                            <p className="error global-error" style={{ marginTop: "12px" }}>{globalError}</p>
                        )}
                        ...
                        {!showManualInputs ? (
                            ...
                            <form onSubmit={handleManualSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                                ...
                                <div style={{ display: "flex", gap: "8px" }}>
                                    ...
                                    {manualNonce && (
                                        <div className="nonce-display-badge" style={{ flex: 1, overflow: "hidden", textOverflow: "ellipsis" }}>
                                            Nonce: {manualNonce}
                                        </div>
                                    )}
                                </div>
