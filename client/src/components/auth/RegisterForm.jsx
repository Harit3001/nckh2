...
export default function RegisterForm({
  ...
  return (
    <div className="register-page">
      ...
      <form className="register-box" onSubmit={onSubmit} noValidate>
          ...
          <>
            ...
            <div className="form-group">
              <select
                ...
                value={bloodType}
                onChange={(e) => onChangeField("bloodType", e.target.value)}
              >
            ...
            <div className="form-group">
              <input
                ...
                value={allergyInfo}
                onChange={(e) => onChangeField("allergyInfo", e.target.value)}
              />
              {errors.allergyInfo && <p className="error">{errors.allergyInfo}</p>}
            </div>
            ...
            <div className="form-group">
              <input
                ...
                value={nationalId}
                onChange={(e) => onChangeField("nationalId", e.target.value)}
              />
          ...
          <>
            <div className="form-group">
              <input
                ...
                value={doctorCode}
                onChange={(e) => onChangeField("doctorCode", e.target.value)}
              />
              {errors.doctorCode && <p className="error">{errors.doctorCode}</p>}
            </div>
            ...
            <div className="form-group">
              <input
                ...
                value={speciality}
                onChange={(e) => onChangeField("speciality", e.target.value)}
              />
            ...
            <div className="form-group">
              <input
                ...
                value={hospitalId}
                onChange={(e) => onChangeField("hospitalId", e.target.value)}
              />
              {errors.hospitalId && <p className="error">{errors.hospitalId}</p>}
            </div>
          </>
        )}
